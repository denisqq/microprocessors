...
SETUP:
	...
	LDI	TEMP,0b00000100			;С. 270 TCCR0    //выбор предделителяна 1024 
	OUT TCCR0,TEMP
...
FIRST_BUTTON:
	LDI led_timing, 30//Примерно 950ms, меняем и в зависмости от значения, чаще-медленее мигает
...
THIRD_BUTTON:
	LDI led_timing, 38//Примерно 1.2, меняем и в зависмости от значения, чаще-медленее мигает
